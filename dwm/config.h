...
#define CHROME "chromium"
#define TOR "torbrowser-launcher"
...
static char *fonts[]          = { "monospace:size=10",  "JetBrainsMono Nerd Font:pixelsize=22:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "60*20", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "calc", NULL };
const char *spcmd3[] = {MUSICPLAYER, "-g", "70*30", NULL};
...
static const Layout layouts[] = {
	...
	{ "[ 󰣨 ]",	tile },	                /* Default: Master on left, slaves on right */
	{ "[ 󰣨 ]",	bstack },               /* Master on top, slaves on bottom */

	{ "[ 󰣨 ]",	spiral },               /* Fibonacci spiral */
	{ "[ 󰣨 ]",	dwindle },              /* Decreasing in size right and leftward */

	{ "[ 󰣨 ]",	deck },	                /* Master on left, slaves in monocle-like mode on right */
	{ "[ 󰣨 ]",	monocle },              /* All windows on top of eachother */

	{ "[ 󰣨 ]",	centeredmaster },               /* Master in middle, slaves on sides */
	{ "[ 󰣨 ]",	centeredfloatingmaster },       /* Same but master floats */

	{ "[ 󰣨 ]",	NULL },	                /* no layout function means floating behavior */
	{ NULL,		NULL },
};
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_r,          spawn,                  {.v = (const char*[]){ EMAILCLIENT, NULL } } }, 
	{ MODKEY|ShiftMask,		XK_r,          spawn,                  SHCMD(TERMINAL " -e abook -C ~/.config/abook/abookrc --datafile ~/.config/abook/addressbook") },
	...
	{ MODKEY,			XK_c,          spawn,                  {.v = (const char*[]){ CHROME, NULL } } },
	...
	{ MODKEY,			XK_m,          spawn,                  {.v = (const char*[]){ MUSICPLAYER, NULL } } },
	...
	{ MODKEY,			XK_Insert,     spawn,                  SHCMD("catbookmarks") },
	{ MODKEY,			XK_F1,         spawn,                  SHCMD("groff -mom /usr/local/share/dwm/larbs.mom -Tpdf | zathura -") },
	{ MODKEY,			XK_F2,         spawn,                  {.v = (const char*[]){ "tutorialvids", NULL } } },
	{ MODKEY,			XK_F3,         spawn,                  {.v = (const char*[]){ "displayselect", NULL } } },
	{ MODKEY,			XK_F4,         spawn,                  SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_F5,         xrdb,                   {.v = NULL } },
	{ MODKEY,			XK_F6,         spawn,                  SHCMD(TERMINAL " xdotool mousemove_relative -- 50 0") },
	...
	{ 0,				XK_Print,      spawn,                  SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png && notify-send Screenshot pic-full-$(date '+%y%m%d-%H%M-%S')") },
  ...
  { 0, XF86XK_AudioStop,                         spawn,                  {.v = (const char*[]){ "playerctl", "stop", NULL } } },
	...
	{ 0, XF86XK_WLAN,                              spawn,                  {.v = (const char*[]){ "wifi-switch", NULL } } },
	...
	{ 0, XF86XK_MonBrightnessUp,                   spawn,                  {.v = (const char*[]){ "brightup", NULL } } },
	{ 0, XF86XK_MonBrightnessDown,                 spawn,                  {.v = (const char*[]){ "brightdown", NULL } } },
